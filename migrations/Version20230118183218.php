 ...
 */
final class Version20230118183218 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produits CHANGE produits_id categories_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produits CHANGE categories_id produits_id INT DEFAULT NULL');
