 ...
 */
final class Version20221205143308 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE genre (id INT AUTO_INCREMENT NOT NULL, homme TINYINT(1) DEFAULT NULL, femme TINYINT(1) DEFAULT NULL, enfant TINYINT(1) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produits ADD genre VARCHAR(10) DEFAULT NULL');
    }
}
